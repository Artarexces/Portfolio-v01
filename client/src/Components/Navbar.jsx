...
const Navbar = () => {
    return (
      <nav className="fixed flex justify-center w-full top-2 left-1/2 transform -translate-x-1/2 z-50">
            <ul className='flex flex-wrap justify-center items-center bg-black/80 backdrop-blur-sm rounded-full px-6 py-1 gap-4 list-none text-sm sm:text-sm md:text-sm lg:text-sm xl:text-sm'>
